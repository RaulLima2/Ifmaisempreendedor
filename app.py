...
def swotinterno():
    return render_template(
        'interno.html',
        respontaswotinternoclassificacao=respontaswotinternoclassificacao, 
        respostaswotinternoimportancia=respostaswotinternoimportancia,
        questaoswotinterno=questaoswotinterno
        )
...
def swot_externo():
    ...
    return render_template(
        'externo.html',
        respontaswotexternoclassificacao=respontaswotexternoclassificacao,
        respostaswotexternoimportancia=respostaswotexternoimportancia,
        questaoswotexterno=questaoswotexterno
        )
...
def matrix_swot():
    if request.method == 'POST':
        ...
        swot.enviar_matrixswot(
            gmail=gmail,
            nomedoarquivo=[empreendedor.setnome()+"externa", empreendedor.setnome()+"interna"], 
            enderecoeletronico="raulbrunoslima@gmail.com", 
            assuntodoenvio="Dados das Empreendedoras"
            )
